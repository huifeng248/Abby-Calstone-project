...
class Comment(db.Model):
    ...
    def to_dict(self):
        return {
            ...
            "user_comment_likes": [{'id':user.id, 'username':user.username, 'last_name':user.last_name, 'first_name':user.first_name, 'profile_img':user.profile_img} for user in self.user_comment_likes] 
        }